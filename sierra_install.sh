...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='sierra.conf'
CONFIGFOLDER='/root/.sierra/mainnet'
COIN_DAEMON='sierrad'
COIN_CLI='sierra-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/sierracoin-foundation/sierra/releases/download/v.2.0.0/daemon-linux2.0.0.zip'
COIN_REPO='https://github.com/sierracoin/sierra-core.git'
...
function download_node() {
  ...
  cp daemon-linux/$COIN_DAEMON daemon-linux/$COIN_CLI $COIN_PATH >/dev/null 2>&1
